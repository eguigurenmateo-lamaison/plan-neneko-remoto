# Análisis de llamada — Octavio Zavala (25 jun)
...
- **Closer:** Simón Mesa — Director de admisiones, Neneko Remoto / programa Freedom.
- **Duración:** 92 min.
- **Oferta / precio:** Programa Freedom, 90 días. Precio lista **$4,500 USD**; bono de acción a **$3,500** (pago único o plan $1,500 + 2×$1,000).
- **Ingreso actual del prospecto:** ~$3,000–$4,000 USD/mes, trabajando 12–14 h/día (burnout).
- **Líquido disponible declarado:** ~$1,000 USD.
- **Resultado:** ❌ **No cierra.** Queda en seguimiento ("te escribo el fin de semana"); se mantiene el bono de $3,500 si decide antes de fin de mes.
...
- **Dolor altísimo y reciente** (claridad "de hace 1 mes"): está en ventana de cambio.
- **Ya validó el resultado** (trabajó remoto desde Japón con éxito): la creencia "no existe un trabajo así" ya está medio rota.
- **Tiene un "para qué" poderoso** (salud, pareja, proyecto de contenido): se puede anclar el ROI emocional ahí.
- **Perfil objetivamente fuerte** (gerente multi-skill, e-commerce, ads, IA, C1): la promesa de *subir* ingresos (no bajarlos) es creíble y poco explotada.
- **Objeción única y nombrada por él mismo: el dinero.** "Lo demás me convence; es el tema económico lo que me limita." Si se resuelve el cómo-pagar, se cae el único muro.
...
1. **Confirmar el presupuesto del formulario al inicio** (no preguntarlo desde cero). Si el formulario previo a la llamada incluye una pregunta de rango de capital a invertir, se retoma temprano para alinear expectativas: *"Oye, me pusiste en el formulario que tienes $1,000 para invertir. ¿Es esto correcto? Sobre todo porque quiero que ambos estemos en la misma página antes de presentarte lo que incluye el programa."* Así el precio no cae en el vacío ni sorprende al minuto 74.
...
5. **Ritual de papel y lápiz antes de los 3 pilares.** Decir textualmente: *"¿Tienes un papel y lápiz a mano? Perfecto, anota 1, 2 y 3, y deja un espacio entre cada uno, porque te voy a explicar los tres pilares. Es mejor si los tienes anotados a mano para que me puedas hacer preguntas en caso de que tengas dudas después de que te lo explique."* Los pilares: **1) Posicionamiento estratégico · 2) Sistema de casa inteligente · 3) Sistema de cierre y tarifa premium.** Se dicen los tres nombres, se explica cada uno y al terminar: *"¿Qué dudas tienes?"* (siempre hay preguntas sobre los pilares). Si no hay dudas de pilares → pasar a explicar **cómo va a ser la entrega del servicio**.
